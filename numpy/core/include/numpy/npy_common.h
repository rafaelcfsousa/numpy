...
#if defined HAVE_ATTRIBUTE_TARGET_VSX4 && defined HAVE_LINK_VSX4
#define NPY_GCC_TARGET_VSX4 __attribute__((target("cpu=power10")))
#elif defined HAVE_ATTRIBUTE_TARGET_VSX4_WITH_INTRINSICS
#define NPY_GCC_TARGET_VSX4 __attribute__((target("cpu=power10")))
#else
#define NPY_GCC_TARGET_VSX4
#endif
/*
...
#if defined HAVE_ALTIVEC_H && defined HAVE_LINK_VSX4
#define NPY_HAVE_VSX4_INTRINSICS
#endif
/*
